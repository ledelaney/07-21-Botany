...
## slide two: maybe a tree you can like highlight certain portions of?
...
+ And beyond agricultural importance, the nearly 20,000 Fabaceae species exhibit a practically unparalleled diversity of traits and features. 
+ Growth forms include trees, shrubs, vines and herbs; they display a stunning diversity of floral features and morphology; as well as highly complex chromosomal evolution
+ Some genera are monotypic like _Tamarindus_; some contain almost 3,000 species like _Astragalus_. 
+ The three historically recognized subfamilies of Fabaceae show marked differences in distribution, morphology and chromosomal evolution-- with the Mimosoid and Caesalpinoid lineages being the oldest, consisting of mostly tropical trees, and the enormous, widespread and mostly herbaceous papilinoideae, the youngest subfamily
+ All together the family is made up of nearly 20,000 species
+ So what accounts for the vibrant diversity and cosmopolitan distribution of the Fabaceae family observed today?
...
+ that is, several _different_ molecular systems have been uncovered across monocots and eudicots, and current work indicates as many as 35 independently-evolved SI systems may exist
...
## slide six: check boxes rsi versus fabaceae
...
+ for starters, the genotype that determines the rejection in RSI is the pollen -- that is, the rejection is gametophytic -- this is true in all investigated Fabaceae species
...
+ however, our findings are not indicative of RSI, or of any single SI mechanism operating
    - arrests all over
    - confusing and murky gentics --> summarize these in a figure?
    - no evidence of a correlation between polyploidy and SC
